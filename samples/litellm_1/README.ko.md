# LiteLLM — 하나의 인터페이스, 모든 제공자

아주 작은 [LiteLLM](https://docs.litellm.ai/) 스크립트입니다. 프롬프트 하나를
`litellm.completion()`으로 보내고 응답을 출력합니다. **같은 호출**이
**Anthropic Claude**, **OpenAI**, **Google AI Studio (Gemini)** 에서 모두
동작합니다 — 코드는 그대로 두고 `.env`의 `MODEL`만 바꾸면 됩니다.
