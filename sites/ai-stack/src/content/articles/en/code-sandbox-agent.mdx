...
Swap the tool for search and you get [[web-search-fx-agent|asking today's FX rate]]; swap it for scraping and you get [[web-scraping-agent|a docs page to Markdown]].  
