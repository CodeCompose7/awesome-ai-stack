...
같은 루프에서 도구만 [스크래핑(Firecrawl)](../web-scraping-agent/)으로 바꾸면 문서를
마크다운으로 읽어 오고, 브라우저 자동화로 바꾸면 또 다른 "지금" 데이터를 끌어올 수
있습니다. 도구의 갈래는 [도구](../../concept/agent-tools/) 개념에 정리해 두었습니다.
