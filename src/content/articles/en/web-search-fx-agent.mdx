...
The [Tools](../../concept/agent-tools/) concept uses "asking today's FX rate"
...
Swap the tool for [scraping (Firecrawl)](../web-scraping-agent/) in the same
loop and it reads a page in as Markdown; swap it for browser automation and it
pulls in a different kind of "now" data. The full set of tool kinds is laid out
in the [Tools](../../concept/agent-tools/) concept.
