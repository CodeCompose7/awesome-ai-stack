...
This zooms in on the *code sandbox* role from [harness engineering](../harness-engineering/). Of all the scaffolding a harness wraps around a model, this is the one axis that confines *execution*.
