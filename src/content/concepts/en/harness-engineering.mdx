...
Each layer below guards against one of the failure modes in [Why it matters](#why-it-matters) above — you don't need them all up front, only where a risk shows.
