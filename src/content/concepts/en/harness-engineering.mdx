...
For a **factual claim**, the **model** answers and **evaluation** scores it against the source, filtering out anything below a threshold. **Tracing** records each step — question, model, evaluation — so you can trace back where it went wrong.
