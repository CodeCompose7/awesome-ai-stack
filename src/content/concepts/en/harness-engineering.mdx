...
These are the substrate the loop calls at each step of the cycle: *the model* does the reasoning, and *tools & web access* do the acting that touches the world. They decide what the agent *can* do — the layers that make it reliable come next.
