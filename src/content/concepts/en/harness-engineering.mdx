...
Factual claims get scored against their source, and anything below a threshold is filtered out. Code and API claims are verified by running them, like the _code sandbox_ above.
