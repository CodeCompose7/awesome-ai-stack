...
<details open>
<summary>Concrete examples — runaway loops</summary>
...
Runs model-written code in isolation, so a bad command can't touch your machine or your data. Disposable runtimes spin up and tear down fast, which is what makes them the safety net behind a code-running agent — isolating **risky side effects** like deleted files or arbitrary network calls.
...
<details open>
<summary>Concrete examples — risky side effects</summary>
...
<details open>
<summary>Concrete examples — unsafe / off-topic output</summary>
...
<details open>
<summary>Concrete examples — "worked yesterday"</summary>
