...
세 컬렉션 모두 프런트매터는 [`stack-site-builder/src/content.ts`](https://github.com/CodeCompose7/stack-site-builder/blob/main/src/content.ts)의
...
있습니다. 테마 마크다운 파이프라인([`stack-site-builder/markdown.mjs`](https://github.com/CodeCompose7/stack-site-builder/blob/main/markdown.mjs))의 `remarkGlossary` 플러그인이
...
스키마([`stack-site-builder/src/content.ts`](https://github.com/CodeCompose7/stack-site-builder/blob/main/src/content.ts))는 필요할 때 더
